...
-- criar de uma só a tabela de relacionamento 
...
--3 Excluir cd_exame = 7 (tb_exame) (vê se é possível ? Explique ? )
...
-- R. Não deixou excluir, por causa da integridade referencial 


--4 Excluir cd_exame = 7 (rl_exame_paciente) (vê se é possível ? Explique ? )

delete rl_exame_paciente 
where cd_exame = 7 

R: Não atingiu a regra de integridade referencial 
